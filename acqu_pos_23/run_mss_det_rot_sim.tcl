...
#
# File         : run_mss_det_rot_sim.tcl
#
# Description  : Script de compilation des fichiers et de lancement
#                de la simulation manuelle de la mss du labo d'acquisition de
#                 position avec la console REDS
#
# Auteur       : Etienne Messerli
# Date         : 07.12.2015
# Version      : 0.0
#
# Use          : Compilation/simulation manuelle mss_det_rot.vhd
#
#--| Modifications |------------------------------------------------------------
...
# tb file compilation
vcom -reportprogress 300 -work work   ../src_tb/console_sim_mss.vhd
