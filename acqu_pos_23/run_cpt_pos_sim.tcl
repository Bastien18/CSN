...
#
# File         : run_cpt_pos_sim.tcl
#
# Description  : Script de compilation des fichiers et de lancement
#                de la simulation manuelle du compteur de position du labo 
#                acquisition de position avec la console REDS
#
# Auteur       : Etienne Messerli
# Date         : 07.12.2015
# Version      : 0.0
#
# Use          : Compilation/simulation manuelle cpt_pos.vhd
#
#--| Modifications |------------------------------------------------------------
...
# tb file compilation
vcom -reportprogress 300 -work work   ../src_tb/console_sim_cpt.vhd
